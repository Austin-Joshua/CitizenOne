...
const DashboardLayout = () => {
  ...
  return (
    <NotificationProvider>
      <a
        href="#main-content"
        className="fixed left-3 top-3 z-[100] -translate-y-16 rounded-md bg-accent-primary px-3 py-2 text-xs font-semibold text-white opacity-0 transition-transform focus:translate-y-0 focus:opacity-100 focus:outline-none"
      >
      ...
      <div className="flex min-h-screen bg-base font-sans text-[15px] leading-relaxed antialiased">
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col">
          ...
          >
            <div className="mx-auto w-full max-w-[1360px] px-5 py-8 sm:px-8 lg:px-10 lg:py-10">
              <Outlet />
            </div>
          </main>
        </div>
